alter table "public"."picks" add column "away_team_primary_hex_color" text;

alter table "public"."picks" add column "away_team_secondary_hex_color" text;

alter table "public"."picks" add column "home_team_primary_hex_color" text;

alter table "public"."picks" add column "home_team_secondary_hex_color" text;
...
AS $function$BEGIN
    ...
    SELECT 
        ...
        away_team_id, away_team_location, away_team_abbreviation, away_team_nickname, away_team_score, away_team_win, home_team_primary_hex_color, home_team_secondary_hex_color, away_team_primary_hex_color, away_team_secondary_hex_color
    INTO 
        NEW.game_start_time,
        ...
        NEW.away_team_id, NEW.away_team_location, NEW.away_team_abbreviation, NEW.away_team_nickname, NEW.away_team_score, NEW.away_team_win, NEW.home_team_primary_hex_color, NEW.home_team_secondary_hex_color, NEW.away_team_primary_hex_color, NEW.away_team_secondary_hex_color
    FROM public.games
