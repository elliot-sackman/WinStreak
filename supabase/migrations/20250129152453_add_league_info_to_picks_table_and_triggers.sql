alter table "public"."picks" add column "league_id" integer;

alter table "public"."picks" add column "league_name" text;

alter table "public"."picks" add column "sport" text;

alter table "public"."picks" add constraint "picks_league_id_fkey" FOREIGN KEY (league_id) REFERENCES leagues(league_id) ON UPDATE CASCADE ON DELETE SET NULL not valid;
